...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__extjs_80c1dc4d6bd8bbd04cf470bd6e075ca4f8797107": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);var node = ($0); node.innerHTML = "" ;
            },
            ...
            "__extjs_d92cd4f2a903e40f8c4f8409dc67f3e9bec326cd": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);var node = ($0); node.style.position = "absolute" ; node.style.left = "0px" ; node.style.top = "0px" ; node.style.width = "2px" ; node.style.height = "100%" ; node.style.zIndex = "2147483647" ; node.style.backgroundColor = "white" ; node.style.pointerEvents = "none" ; node.style.display = "none" ;
            },
            ...
            "__extjs_0471360b99fc72c927fb13a143d9a90a05cc785f": function($0, $1) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);var node = ($0); node.style.left = ($1);
            },
            ...
            "__extjs_4af57ac0cfb439f679ddde31d16d6db3509b7ca7": function($0, $1) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);var node = ($0); node.style.position = "absolute" ; node.style.left = "0px" ; node.style.top = ($1);
            },
