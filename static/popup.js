...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__extjs_87616703d222b93d1d65aa230431d0d7fdfe65e4": function($0, $1) {
            ...
            "__extjs_6a4326e3602dc2e6b8cfcbcbe0b7e655731a2ecd": function($0, $1) {
            ...
            "__extjs_4e4313f9d787b8c358a8bda0b86d6901bafe73fb": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return new Promise (function (resolve , reject){chrome.runtime.sendMessage (null , ($1), null , function (x){if (chrome.runtime.lastError != null){console.log (chrome.runtime.lastError); reject (chrome.runtime.lastError);}else if (x.type ==="success"){resolve (x.value);}else {reject (new Error (x.error));}});});})());
            },
            ...
            "__extjs_55eb5fd0fb77ab3da08a9643f636d6975670c707": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return {type : "records:insert" , value : ($1)};})());
            },
            ...
            "__extjs_d40824d0fa7a13dae181e76f58f0550174f8dfc7": function($0) {
            ...
            "__extjs_be46bf3b533c47680df9c63c7d37279330d1bc2b": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){return {type : "records:get-all"};})());
            },
            ...
            "__extjs_64c352bb246f02695dca3140f54a572d50189879": function($0, $1, $2) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);var on_progress = ($0); var on_done = ($1); var reader = new FileReader (); reader.onprogress = function (e){on_progress (e.loaded , e.total);}; reader.onload = function (e){on_progress.drop (); on_done (e.target.result);}; reader.readAsText (($2));
            },
            ...
            "__extjs_f96993149375eec7e8c7334ef7daabd3eb2170af": function($0) {
            ...
            "__extjs_cd78bdc5d7dcc16655b6f6809d762546e4242bf8": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){return {type : "records:delete-all"};})());
            },
            ...
            "__extjs_4ad5884e5c11f5e51dc9d868c36473de3a1e2706": function($0, $1) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);var blob = new Blob ([($0)], {type : "application/json"}); var url = URL.createObjectURL (blob); chrome.downloads.download ({url : url , filename : ($1), saveAs : true , conflictAction : "prompt"}, function (){URL.revokeObjectURL (url);});
            },
            ...
            "__extjs_9d4367935a73a76045f92cd57dc2aa6f7689c9ea": function($0) {
