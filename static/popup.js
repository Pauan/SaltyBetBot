...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof window === "undefined" && typeof process === "object" ) {
            ...
            var wasm_path = path.join( __dirname, "popup.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch(chrome.runtime.getURL("popup.wasm"), {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'popup'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'popup':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            env: {
                "__cargo_web_snippet_01a022cd3038e0da89a82391b9301b0e63d31cf9": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){return new Date().toISOString().replace(new RegExp("\\:","g"),"_");})());
            },
            ...
            "__cargo_web_snippet_0c892da2fe1083c078ddfedc2dc08090ac00965a": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return new Promise(function(resolve,reject){chrome.runtime.sendMessage(null,($1),null,function(x){if(chrome.runtime.lastError !=null){reject(new Error(chrome.runtime.lastError.message));}else{resolve(x);}});});})());
            },
            ...
            "__cargo_web_snippet_24011c334b42ea50f38f62d791be21637982c5b6": function($0) {
            ...
            "__cargo_web_snippet_2f701345805f1e942c94bd87816e24830365b27c": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);($0).style.display="flex";
            },
            "__cargo_web_snippet_325c12d2bb333c728167fa2b8e96ddc14e28b42d": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);($0).target.value="";
            },
            ...
            "__cargo_web_snippet_40a874ed058311b567cbe1e678353b989929cd45": function($0, $1, $2) {
            ...
            "__cargo_web_snippet_49a68804a285ca1e483868323598e8dc4f3b8663": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);document.getElementById(($0)).click();
            },
            "__cargo_web_snippet_4fd31c9e56d40b8642cf9e6f96fd6b570f355cea": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);console.error(($0));
            },
            "__cargo_web_snippet_5129bc94a1c55db2f63373e2db984b3eda6516fd": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){var files=($1).target.files;if(files.length===1){return files[0];}else{return null;}})());
            },
            ...
            "__cargo_web_snippet_685bd4f896566b523b743b55d0106ab1f9c3b0d7": function($0, $1) {
            ...
            "__cargo_web_snippet_767bbb728f100528f5762c6e361778d57d1139be": function($0, $1, $2) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){return new Promise(function(resolve,reject){var on_progress=($1);var reader=new FileReader();reader.onprogress=function(e){on_progress(e.loaded,e.total);};reader.onload=function(e){on_progress.drop();resolve(e.target.result);};reader.readAsText(($2));});})());
            },
            ...
            "__cargo_web_snippet_95dbaae1a7058a951ee6991220217aa96a850661": function($0, $1) {
            ...
            "__cargo_web_snippet_aa3dc7bef158cb25b79179231419a44c1c63dcbf": function($0, $1, $2) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){return new Promise(function(resolve,reject){var url=URL.createObjectURL(($1));chrome.downloads.download({url:url,filename:($2),saveAs:true,conflictAction:"prompt"},function(){URL.revokeObjectURL(url);resolve();});});})());
            },
            ...
            "__cargo_web_snippet_b0ab5796360e92146e2f660f3f717ccb97ea0870": function($0, $1, $2) {
            ...
            "__cargo_web_snippet_b62ab0c74e06ddfd36f6842d19148f049b6b99a3": function($0) {
            ...
            "__cargo_web_snippet_c9501c5c45fa4bbceffa4a475c5ee1b2832d8666": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);chrome.tabs.create({url:chrome.runtime.getURL(($0))});
            },
            "__cargo_web_snippet_d5a3814fc69fdcebf994e5d073983d6bdc0fb357": function($0) {
            ...
            "__cargo_web_snippet_d95e718b9d0e510b4f3097fa5b29574f7f2472dd": function($0, $1, $2, $3) {
            ...
            "__cargo_web_snippet_eb5415fc52d377cac91477306809cbe56bdeab56": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return new Blob([($1)],{type:"application/json"});})());
            },
