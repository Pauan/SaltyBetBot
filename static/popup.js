...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            env: {
                "__extjs_8a51a8600998cf6e0ac9573d4fc671ed535d91f9": function($0, $1) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);chrome.runtime.sendMessage (null , {type : "records:insert" , value : ($0)}, null , function (){($1)();});
            },
            ...
            "__extjs_333a5adefb112840a58c0f0a8798f808aff5c10a": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);chrome.runtime.sendMessage (null , {type : "records:delete-all"}, null , function (){($0)();});
            },
            ...
            "__extjs_df88d6ca6971a9687db7f1ccb90be4b1953e1dca": function($0, $1) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);document.getElementById (($0)). addEventListener ("click" , function (){($1)();}, true);
            },
            "__extjs_0040db26f6f24165a30b3137894481330256f17e": function($0, $1, $2, $3) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);$3 = Module.STDWEB_PRIVATE.to_js($3);var on_start = ($0); var on_progress = ($1); var on_done = ($2); document.getElementById (($3)). addEventListener ("change" , function (event){var files = event.target.files ; if (files.length ===1){var reader = new FileReader (); reader.onprogress = function (e){on_progress (e.loaded , e.total);}; reader.onload = function (e){on_done (e.target.result);}; on_start (); reader.readAsText (files [0]);}}, true);
            },
