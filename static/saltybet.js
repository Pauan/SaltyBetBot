...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__extjs_b99cfa99d8250298312cb71dd4ab8e05bc249cd0": function($0, $1) {
            ...
            "__extjs_24e8536c1e28c29e7c058527c807c005521cd9b6": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){return {type : "tabs:open-twitch-chat"};})());
            },
            ...
            "__extjs_aea59b0d708077a11a2a3177816249c03c7dfc7a": function($0, $1, $2) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){var self = ($1); var callback = ($2); function listener (message){callback (message);}function stop (){self.onMessage.removeListener (listener); self.onDisconnect.removeListener (stop); callback.drop ();}self.onMessage.addListener (listener); self.onDisconnect.addListener (stop); return stop ;})());
            },
